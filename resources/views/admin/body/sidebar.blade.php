            ...
            <ul id="side-menu">
                ...
                <li>
                    ...
                    <div class="collapse" id="contacts">
                        <ul class="nav-second-level">
                            ...
                            <li>
                                <a href="{{ route('all.customer') }}" class="tp-link">Customers</a>
                            </li>
                            <li>
                                <a href="{{ route('all.customer_group') }}" class="tp-link">Customer Groups</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarProducts">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{ route('all.product') }}" class="tp-link">List Products</a>
                            </li>
                            <li>
                                <a href="{{ route('add.product') }}" class="tp-link">Add Products</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="{{ route('all.category') }}" class="tp-link">Categories</a>
                            </li>
                            <li>
